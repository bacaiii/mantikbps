...
<?php
    ...
    $makeSortUrl = function ($column) use ($sortBy, $sortDir) {
        ...
        return route('employee.dashboard', array_merge(request()->query(), [
            'sort_by' => $column,
            'sort_dir' => $newDir,
        ]));
    };
...
<style>
    ...
    .dashboard-summary-table { table-layout: fixed; width: 100%; font-size: 12.6px; }
    .dashboard-summary-table th, .dashboard-summary-table td { white-space: normal; word-break: break-word; padding: 9px 7px !important; }
    .dashboard-summary-table col.col-title { width: 28%; }
    .dashboard-summary-table col.col-category { width: 9%; }
    .dashboard-summary-table col.col-date, .dashboard-summary-table col.col-check-date, .dashboard-summary-table col.col-start-date { width: 12%; }
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\manajemen-publikasi-statistik\resources\views/employee/dashboard.blade.php ENDPATH**/ ?>