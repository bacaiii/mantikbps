...
<head>
    ...
    <title>MANTIK - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
        ...
        <div class="nav-wrapper">
            <nav class="nav flex-column">
                ...
                <a href="<?php echo e(route('tenant.dashboard')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.dashboard') ? 'active' : ''); ?>"
                   title="Dashboard">
                    <i class="bi bi-speedometer2"></i>
                    <span class="link-text">Dashboard</span>
                </a>

                <a href="<?php echo e(route('tenant.publications.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.publications.*') ? 'active' : ''); ?>"
                   title="Manajemen Publikasi">
                    <i class="bi bi-journal-text"></i>
                    <span class="link-text">Manajemen Publikasi</span>
                </a>

                <a href="<?php echo e(route('tenant.user-accounts.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.user-accounts.*') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('tenant.team-allocations.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.team-allocations.*') ? 'active' : ''); ?>"
                   title="Tim Kerja Publikasi">
                    <i class="bi bi-people"></i>
                    <span class="link-text">Tim Kerja Publikasi</span>
                </a>

                <a href="<?php echo e(route('tenant.team-templates.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.team-templates.*') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('tenant.publication-progress.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.publication-progress.*') ? 'active' : ''); ?>"
                   title="Progres Publikasi">
                    <i class="bi bi-graph-up-arrow"></i>
                    <span class="link-text">Progres Publikasi</span>
                </a>

                <a href="<?php echo e(route('tenant.inspection-guidelines.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.inspection-guidelines.*') ? 'active' : ''); ?>"
                   title="Kelola Pedoman">
                    <i class="bi bi-ui-checks-grid"></i>
                    <span class="link-text">Kelola Pedoman</span>
                </a>

                <a href="<?php echo e(route('tenant.knowledge.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.knowledge.*') ? 'active' : ''); ?>"
                   title="Knowledge">
                    <i class="bi bi-link-45deg"></i>
                    <span class="link-text">Knowledge</span>
                </a>

                <a href="<?php echo e(route('tenant.ready-release.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tenant.ready-release.*') ? 'active' : ''); ?>"
                   title="Publikasi Siap Rilis">
                    <i class="bi bi-box-seam"></i>
                    <span class="link-text">Publikasi Siap Rilis</span>
                </a>

                <?php if(auth()->user()->role === 'admin_provinsi'): ?>
                    <span class="nav-section-label">Provinsi</span>

                    <a href="<?php echo e(route('tenant.monitoring.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('tenant.monitoring.*') ? 'active' : ''); ?>"
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        <?php echo e(optional(auth()->user()->tenant)->name); ?> - <?php echo e(optional(auth()->user()->tenant)->wilayah); ?>
...
</html><?php /**PATH C:\laragon\www\manajemen-publikasi-statistik\resources\views/layouts/tenant.blade.php ENDPATH**/ ?>