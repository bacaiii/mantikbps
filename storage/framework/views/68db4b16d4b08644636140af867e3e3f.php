...
<head>
    ...
    <style>
        ...
        .workflow-side::before {
            ...
            position: absolute;
            inset: 0;
            background-image: url('<?php echo e(asset('images/logo-bps.png')); ?>');
    ...
    <div class="login-page">
        <header class="login-header">
            <div class="d-flex align-items-center gap-3">
                <img src="<?php echo e(asset('images/logo-bps.png')); ?>" alt="Logo BPS" class="brand-logo">
                <div>
                ...
                <section class="login-form-side">
                    ...
                    <form action="<?php echo e(route('login.post')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="login" class="form-control" value="<?php echo e(old('login')); ?>" placeholder="Masukkan ID login atau email" required>
                        </div>
                        ...
                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none fw-semibold small">
...
<?php /**PATH C:\laragon\www\manajemen-publikasi-statistik\resources\views/auth/login.blade.php ENDPATH**/ ?>