    ...
    <div class="card table-card">
        ...
        <div class="card-body">
            ...
            <form method="GET" class="row g-2 mb-3">
                ...
                <div class="col-md-2">
                    <select name="task" class="form-select">
                        ...
                        <?php $__currentLoopData = $taskOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taskValue => $taskLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($taskValue); ?>" <?php echo e((string) $selectedTask === (string) $taskValue ? 'selected' : ''); ?>><?php echo e($taskLabel); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="col-md-2">
                    <select name="status" class="form-select">
                        ...
                        <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusValue => $statusLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($statusValue); ?>" <?php echo e((string) $selectedStatus === (string) $statusValue ? 'selected' : ''); ?>><?php echo e($statusLabel); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            ...
            <div class="table-fit-wrapper employee-task-table-wrapper">
                ...
                <thead>
                    <tr>
                        <th class="<?php echo e($sortThClass('tim')); ?>">
                            <a href="<?php echo e($makeSortUrl('tim')); ?>" class="<?php echo e($sortLinkClass('tim')); ?>">
                                <span>Tim Kerja</span><?php echo $sortIcon('tim'); ?>

                            </a>
                        </th>
                        <th class="<?php echo e($sortThClass('publikasi')); ?>">
                            <a href="<?php echo e($makeSortUrl('publikasi')); ?>" class="<?php echo e($sortLinkClass('publikasi')); ?>">
                                <span>Nama Publikasi</span><?php echo $sortIcon('publikasi'); ?>

                            </a>
                        </th>
                        <th class="text-center <?php echo e($sortThClass('tanggal_rilis')); ?>">
                            <a href="<?php echo e($makeSortUrl('tanggal_rilis')); ?>" class="<?php echo e($sortLinkClass('tanggal_rilis')); ?> justify-content-center">
                                <span>Tanggal Rilis</span><?php echo $sortIcon('tanggal_rilis'); ?>

                            </a>
                        </th>
                        <th class="<?php echo e($sortThClass('tugas')); ?>">
                            <a href="<?php echo e($makeSortUrl('tugas')); ?>" class="<?php echo e($sortLinkClass('tugas')); ?>">
                                <span>Tugas Saya</span><?php echo $sortIcon('tugas'); ?>

                            </a>
                        </th>
                        <th class="text-center <?php echo e($sortThClass('status')); ?>">
                            <a href="<?php echo e($makeSortUrl('status')); ?>" class="<?php echo e($sortLinkClass('status')); ?> justify-content-center">
                                <span>Status Publikasi</span><?php echo $sortIcon('status'); ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <?php $__currentLoopData = $visibleAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr>
                                <td class="employee-task-team-cell">
                                    <span class="employee-task-team-preview" title="<?php echo e($teamName); ?>"><?php echo e($shortTeamName($teamName)); ?></span>
                                    <?php if($isLongTeamName): ?>
                                        <button type="button" class="employee-team-more-btn" data-team-target="<?php echo e($teamToggleId); ?>" aria-expanded="false">
                                            Lihat Selengkapnya
                                        </button>
                                        <div id="<?php echo e($teamToggleId); ?>" class="employee-task-team-full" hidden>
                                            <?php echo e($teamName); ?>
                                ...
                                <td>
                                    <div class="fw-semibold text-dark" style="font-size:15px; line-height:1.3;">
                                        <?php echo e(optional($team->publication)->nama_publikasi); ?>

                                    </div>
                                    <div class="employee-task-schedule-chips mt-2">
                                        <span style="<?php echo e($scheduleChipStyle); ?>" title="Penyusunan">Penyusunan <?php echo e($formatScheduleDate(optional($team->publication)->jadwal_mulai_penyusunan)); ?></span>
                                        <span style="<?php echo e($scheduleChipStyle); ?>" title="Pemeriksaan">Pemeriksaan <?php echo e($formatScheduleDate(optional($team->publication)->jadwal_mulai_pemeriksaan)); ?></span>
                                        <span style="<?php echo e($scheduleChipStyle); ?>" title="Upload">Upload <?php echo e($formatScheduleDate(optional($team->publication)->jadwal_upload)); ?></span>
                                    </div>
                                </td>
                                <td class="text-center"><?php echo $formatReleaseDateStack(optional($team->publication)->jadwal_rilis); ?></td>
                                <td><?php echo e($myRoles); ?></td>
                                <td class="text-center">
                                    <span class="status-chip <?php echo e(optional($team->publication)->status_css_class ?? 'secondary'); ?>">
                                        <?php echo e(optional($team->publication)->status_label); ?>

                                    </span>
                                </td>
                                <td class="text-center employee-task-action-cell">
                                    <?php if($taskAction['disabled']): ?>
                                        <button type="button" class="<?php echo e($taskAction['class']); ?>" style="<?php echo e($taskAction['style']); ?>" disabled title="<?php echo e($taskAction['note']); ?>">
                                            <i class="bi bi-lock-fill me-1"></i> <?php echo e($taskAction['label']); ?>

                                        </button>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('employee.tasks.show', ['publicationTeam' => $team->id, 'role' => $assignment->assignment_role])); ?>" class="<?php echo e($taskAction['class']); ?>" style="<?php echo e($taskAction['style']); ?>">
                                            <?php echo e($taskAction['label']); ?>

                                        </a>
                                    <?php endif; ?>

                                    <?php if($taskAction['note']): ?>
                                        <div class="text-danger mt-1" style="font-size:9px; line-height:1.1;"><?php echo e($taskAction['note']); ?></div>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\manajemen-publikasi-statistik\resources\views/employee/tasks/index.blade.php ENDPATH**/ ?>