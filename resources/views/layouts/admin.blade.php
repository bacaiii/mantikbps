...
<head>
    ...
    <title>MANTIK - @yield('title', 'Admin Sistem')</title>
        ...
        <div class="nav-wrapper">
            <nav class="nav flex-column">
                ...
                <a href="{{ route('admin.system.dashboard') }}"
                   class="nav-link {{ request()->routeIs('admin.system.dashboard') ? 'active' : '' }}"
                   title="Dashboard">
                    <i class="bi bi-speedometer2"></i>
                    <span class="link-text">Dashboard</span>
                </a>

                <a href="{{ route('admin.system.tenant-accounts.index') }}"
                   class="nav-link {{ request()->routeIs('admin.system.tenant-accounts.*') ? 'active' : '' }}"
                   title="Kelola Akun BPS">
                    <i class="bi bi-buildings"></i>
                    <span class="link-text">Kelola Akun BPS</span>
                </a>
            </nav>
        </div>
    </aside>
