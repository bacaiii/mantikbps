...
@php
    ...
    $makeSortUrl = function ($column) use ($sortBy, $sortDir) {
        ...
        return route('leader.dashboard', array_merge(request()->query(), [
            'sort_by' => $column,
            'sort_dir' => $newDir,
        ]));
    };
...
<style>
    ...
    .breakdown-row { display: flex; gap: 6px; justify-content: center; flex-wrap: wrap; margin-top: 6px; }
    .breakdown-chip { font-size: 10.5px; font-weight: 700; padding: 2px 9px; border-radius: 999px; border: 1px solid; }
